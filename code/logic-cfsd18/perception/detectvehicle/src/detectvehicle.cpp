...
DetectVehicle::DetectVehicle(int32_t const &a_argc, char **a_argv)
    : DataTriggeredConferenceClientModule(
      a_argc, a_argv, "logic-cfsd18-perception-detectvehicle")
    , m_initialised(false)
    , m_convNeuralNet()
    , m_scale(1, 1, 1)
    , m_sourceName()
...
void DetectVehicle::setUp()
{
  ...
  m_sourceName = kv.getValue<std::string>("logic-cfsd18-perception-detectvehicle.source");
  ...
  m_debugMode = (kv.getValue<int32_t> ("logic-cfsd18-perception-detectvehicle.debug") == 1);
